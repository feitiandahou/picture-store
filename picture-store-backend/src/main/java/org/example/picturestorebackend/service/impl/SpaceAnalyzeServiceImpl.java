...
import org.example.picturestorebackend.model.dto.space.analyze.*;
...
import org.example.picturestorebackend.model.vo.space.analyze.*;
import org.example.picturestorebackend.service.PictureService;
import org.example.picturestorebackend.service.SpaceAnalyzeService;
...
public class SpaceAnalyzeServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public List<SpaceUserAnalyzeResponse> getSpaceUserAnalyze(SpaceUserAnalyzeRequest spaceUserAnalyzeRequest, User loginUser) {
        ...
        //补充分析维度: 每日、每周、每月
        String timeDimesion = spaceUserAnalyzeRequest.getTimeDimension();
        switch (timeDimesion){
            case "day":
